        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                if event.key == pygame.K_LEFT:
                    move_tiles(window, tiles, clock, direction='left')
                if event.key == pygame.K_RIGHT:
                    move_tiles(window, tiles, clock, direction='right')
                if event.key == pygame.K_UP:
                    move_tiles(window, tiles, clock, direction='up')
                if event.key == pygame.K_DOWN:
                    move_tiles(window, tiles, clock, direction='down')
        draw(window, tiles)
